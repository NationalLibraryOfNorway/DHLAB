...
def get_places(urn: str) -> DataFrame:
    ...
    Call the API :py:obj:`~dhlab.api.constants.BASE_URL` endpoint
...
def get_dispersion(
    ...
    Call the API :py:obj:`~dhlab.api.constants.BASE_URL` endpoint ``/dispersion``.
...
def get_metadata(urns: List[str] | None = None) -> DataFrame:
    ...
    Calls the API :py:obj:`~dhlab.api.constants.BASE_URL` endpoint
...
def word_variant(word: str, form: str, lang: str = "nob") -> list:
    ...
    Call the API :py:obj:`~dhlab.api.constants.BASE_URL` endpoint ``/variant_form``
...
def word_paradigm(word: str, lang: str = "nob") -> list:
    ...
    Call the API :py:obj:`~dhlab.api.constants.BASE_URL` endpoint ``/paradigm``
